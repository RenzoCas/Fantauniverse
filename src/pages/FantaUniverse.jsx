...
export default function FantaUniverse() {
	...
	return (
		<>
			...
			<main className="flex min-h-[calc(100dvh-64px)] mx-auto py-[24px] px-[16px] bg-white lg:bg-(--black-light) lg:max-w-full lg:py-[8px] lg:px-0 lg:max-h-screen lg:h-screen">
				<SidebarDesktop />
