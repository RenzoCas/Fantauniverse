...
import { NavLink, useLocation } from "react-router-dom"; // Usa "react-router-dom" per la navigazione in React
import styles from "./Navbar.module.css";
import { Bars3Icon } from "@heroicons/react/20/solid"; // v2
import { XMarkIcon } from "@heroicons/react/20/solid"; // v2
